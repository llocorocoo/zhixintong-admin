...
export const mockUsers: (User & { password: string })[] = [
  ...
  { id: '4', username: 'admin02', password: 'admin123', name: '运营专员', role: 'admin', isSuperAdmin: false, permissions: ['channel:view', 'channel:edit', 'channel:pure_detail', 'order:view', 'transaction:view'] },
];
